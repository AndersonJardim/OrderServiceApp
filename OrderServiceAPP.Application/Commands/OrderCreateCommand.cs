...
{
    /// <summary>
    /// Modelo de dados COMMAND para gravação de pedido
    /// </summary>
    public class OrderCreateCommand
    {
        ...
        [RegularExpression(@"^\d{4}-\d{2}-\d{2}$", ErrorMessage = "Data inválida, use o formato yyyy-MM-dd")]
        [Required(ErrorMessage = "Informe a data da tarefa.")]
        public string? Data { get; set; }

        [RegularExpression(@"^\d{2}:\d{2}$", ErrorMessage = "Hora inválida, use o formato HH:mm")]
